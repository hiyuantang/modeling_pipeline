...
def main():
    ...
    parser.add_argument('--pre_trained_torchvision', type=str2bool, default=True, help='Pre-trained weights for the model from torchvision')
    ...
    parser.add_argument('--test_only', type=str2bool, default=False, help='Make model inference only without training')
